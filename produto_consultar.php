...
<?php
    ...
    echo "<tr><th> codigo </th> <th> nome </th> <th> descricao </th> <th> cor </th> <th> tamanho </th></tr>";
    $endBD="localhost";
    $user="root";
    $senha="";
    ...
    while ($linha = $resultado->fetch(PDO::FETCH_OBJ)){
        echo "<tr><td> $linha->codigo </td> <td>$linha->nome </td> <td> $linha->descricao </td> <td> $linha->cor</td> <td> $linha->tamanho</td></tr>";
    }
echo"</table>";
    $conexao=null;
